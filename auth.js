...
const SUPABASE_URL      = 'REPLACE_WITH_YOUR_SUPABASE_URL';       // e.g. https://xyzxyz.supabase.co
const SUPABASE_ANON_KEY = 'REPLACE_WITH_YOUR_SUPABASE_ANON_KEY';  // starts with "eyJ..."
...
(function(window) {
    ...
    async function updateHeaderLink() {
        ...
        const session = await init();
        if (session) {
            linkEl.textContent = BiocharI18n ? BiocharI18n.t('common.my_projects') : 'My Projects →';
            linkEl.href = 'projects.html';
        } else {
            linkEl.textContent = BiocharI18n ? BiocharI18n.t('common.sign_in') : 'Sign in →';
