window.BiocharTranslations = {
  ...
  en: {
    common: {
      ...
      sign_out: "Sign out",
      footer_about_link: "Meet the team behind this project →",
    },
    about: {
      page_title: "About — Biochar Calculator",
      heading: "Made By",
      intro:
        "This calculator was built as a Climatebase Fellowship capstone project by a cross-cohort team of volunteers, combining coffee & cacao supply chain expertise with software and design to make biochar project feasibility accessible to producers across Latin America.",
      section_core_team: "Core Team",
      section_cohort8: "Project Team — Cohort 8",
      section_cohort9: "Project Team — Cohort 9",
      section_special_thanks: "Special Thanks",
      role_capstone_lead: "Capstone Lead",
      role_software_engineer: "Software Engineer",
      role_design: "Graphic Design & UX",
  ...
  es: {
    common: {
      ...
      footer_about_link: "Conoce al equipo detrás de este proyecto →",
    },
    about: {
      page_title: "Acerca de — Calculadora de Biochar",
      heading: "Creado Por",
      intro:
        "Esta calculadora fue desarrollada como proyecto capstone del Climatebase Fellowship por un equipo de voluntarios de varias cohortes, combinando experiencia en cadenas de suministro de café y cacao con software y diseño para hacer accesible el análisis de viabilidad de proyectos de biochar a productores de toda América Latina.",
      section_core_team: "Equipo Principal",
      section_cohort8: "Equipo del Proyecto — Cohorte 8",
      section_cohort9: "Equipo del Proyecto — Cohorte 9",
      section_special_thanks: "Agradecimientos Especiales",
      role_capstone_lead: "Líder del Capstone",
      role_software_engineer: "Ingeniero de Software",
      role_design: "Diseño Gráfico y UX",
  ...
  pt: {
    common: {
      ...
      sign_out: "Sair",
      footer_about_link: "Conheça a equipe por trás deste projeto →",
    },
    about: {
      page_title: "Sobre — Calculadora de Biochar",
      heading: "Criado Por",
      intro:
        "Esta calculadora foi desenvolvida como projeto capstone do Climatebase Fellowship por uma equipe de voluntários de várias coortes, combinando experiência em cadeias de suprimento de café e cacau com software e design para tornar a análise de viabilidade de projetos de biochar acessível a produtores em toda a América Latina.",
      section_core_team: "Equipe Principal",
      section_cohort8: "Equipe do Projeto — Coorte 8",
      section_cohort9: "Equipe do Projeto — Coorte 9",
      section_special_thanks: "Agradecimentos Especiais",
      role_capstone_lead: "Líder do Capstone",
      role_software_engineer: "Engenheiro de Software",
      role_design: "Design Gráfico e UX",
